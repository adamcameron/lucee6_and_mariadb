...
```
# start from your `lucee6_and_mariadb` directory.

$ pwd
/mnt/c/src/containers/lucee6_and_mariadb/
...
# ⠿ Network lucee6_and_mariadb_backend       Created          0.0s
# ⠿ Volume "lucee6_and_mariadb_mariaDbData"  Created          0.0s
# ⠿ Container lucee6_and_mariadb-lucee-1     Started          2.0s
# ⠿ Container lucee6_and_mariadb-mariadb-1   Started          1.9s


$ docker exec --interactive --tty lucee6_and_mariadb-lucee-1 /bin/bash
